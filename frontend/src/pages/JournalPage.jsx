...
function JournalPage() {
    ...
    // Tracks which journal entry is currently open on the right page
    const [selectedEntryId, setSelectedEntryId] = useState(null);

    // Controls whether the right page shows the new-entry form or an existing entry
    const [isCreatingEntry, setIsCreatingEntry] = useState(true);

    // Controls the journal color theme and saves it locally for the user
    const [journalTheme, setJournalTheme] = useState(
        localStorage.getItem("journalTheme") || "default"
    );

    // Creates a smooth page-turn effect when switching between journal pages
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Automatically open the new entry after it is created
    ...
    return (
        <section className="animate-fade-in">
            ...
            <div className="grid gap-8 xl:grid-cols-[340px_1fr]">
                ...
                {/* Right side open digital journal */}
